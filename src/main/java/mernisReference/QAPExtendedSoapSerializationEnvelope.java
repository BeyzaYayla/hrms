...
public class QAPExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(QAPDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new QAPStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static QAPDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static QAPDateTimeConverter dateTimeConverter = new QAPStandardDateTimeConverter();

    public QAPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public QAPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new QAPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=QAPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,QAPExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=QAPHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
