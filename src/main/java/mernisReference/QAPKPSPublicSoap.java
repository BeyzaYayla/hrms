...
public class QAPKPSPublicSoap
{
    ...
    public QAPKPSPublicSoap(){}

    public QAPKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public QAPKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        QAPExtendedSoapSerializationEnvelope envelope= new QAPExtendedSoapSerializationEnvelope(QAPExtendedSoapSerializationEnvelope.VER11);
